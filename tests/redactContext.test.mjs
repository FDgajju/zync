...
runTest('redacts realistic terminal secrets', () => {
  const cases = [
    ...
    ['Google OAuth token', 'ya29.a0AfH6SMBabcdefghijklmnopqrstuvwxyz0123456789', 'ya29.'],
    ['GitLab PAT', 'glpat-abcdefghijklmnopqrstuvwxyz012345', 'glpat-'],
    ['npm access token', 'npm_abcdefghijklmnopqrstuvwxyz0123456789', 'npm_'],
